...
T = TypeVar("T", bound="GetNodeResponse200")


@attr.s(auto_attribs=True)
class GetNodeResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_node_response_200.additional_properties = d
        return get_node_response_200
