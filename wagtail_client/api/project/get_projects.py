...
def _parse_response(*, response: httpx.Response) -> Optional[GetProjectsResponse200]:
...
def _build_response(*, response: httpx.Response) -> Response[GetProjectsResponse200]:
    return Response(
...
def sync(
    *,
    client: Client,
) -> Optional[GetProjectsResponse200]:
    """Get Projects
